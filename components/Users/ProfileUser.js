...
// import ReportUserPage from "./ReportUserPage"; // Make sure to import your ReportUserPage component
...
// 	const [postCount, setPostCount] = useState(0); // State để lưu số lượng bài đăng
...
// 				// Set avatar and cover photo from user data
// 				setAvatar(response.data.avatar); // Assuming avatar is a valid URL returned from API
// 				setCoverPhoto(response.data.coverPhoto); // Similarly for cover photo

// 				// Check if current user is following this user on ProfileUser page
...
// 				// Fetch user posts
// 				const userPostsResponse = await authApi().get(
// 					endpoints["posts"],
// 					{ params: { user: userId } }
// 				);
...
// 							const postImageUrl = `http://192.168.1.47:8000/${post.id}/images`;
// 							const postImageResponse = await authApi().get(
// 								postImageUrl
// 							);
// 							return {
// 								...post,
// 								images: postImageResponse.data.map(
// 									(image) => image.image
// 								),
// 							};
// 						})
...
// 					// Filter only the posts of the current user
...
// 				} else {
// 					console.error(
// 						"User posts data structure is invalid:",
...
// 						.catch((error) => {
// 							console.error(
// 								"Error retrieving current user ID:",
// 								error
// 							);
// 						});
// 				}
...
// 							coverPhoto
// 								? { uri: coverPhoto }
// 								: require("./assets/images/default_cover.jpg")
// 						}
...
// 					</View>
// 					<View style={[MyStyles.row]}>
// 						<Text style={[styles.text, MyStyles.margin]}>
// 							Theo dõi: {user.followers}
// 						</Text>
// 						<Text style={[styles.text, MyStyles.margin]}>
...
// 									<Text Text style={styles.postTitle}>
// 										{post.title}
// 									</Text>
// 								</View>
// 							</TouchableOpacity>
